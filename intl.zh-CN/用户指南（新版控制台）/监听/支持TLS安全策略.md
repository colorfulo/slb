# 支持TLS安全策略 {#concept_pvl_f1v_cfb .concept}

性能保障型负载均衡实例在创建和配置HTTPS监听时，支持选择使用的TLS安全策略。

您可以在添加或者配置HTTPS监听，配置**协议&监听**的高级配置时，选择TLS安全策略，详细操作参见[添加HTTPS监听](intl.zh-CN/用户指南（新版控制台）/监听/添加HTTPS监听.md#)。

![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/21323/153689297311859_zh-CN.png)
