...
-   上传本教程中需要使用的证书，具体操作请参见[上传证书](cn.zh-CN/用户指南（新版控制台）/证书管理/上传证书.md#)。
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/15661/15350112548320_zh-CN.png)
...
2.  在左侧导航栏，单击**监听**。找到已创建的HTTPS监听，单击**添加转发策略**。
3.  在转发策略页面，配置转发策略，详情请参见[添加域名和路径转发](cn.zh-CN/用户指南（新版控制台）/监听/添加域名和路径转发.md#)。
    ...
    **说明：** 转发规则中设置的域名，必须与证书中和[步骤三 添加扩展域名](cn.zh-CN/用户指南（新版控制台）/监听/扩展域名（Beta）/配置教程.md#section_bk4_ypt_q2b)中添加的扩展域名保持一致。

    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/17005/15350112548327_zh-CN.png)
...
1.  单击SLB1实例ID，进入实例详情页面。
2.  在左侧导航栏，单击**监听**。找到已创建的HTTPS监听，选择**管理** \> **扩展域名管理**。

    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/17020/153501125410044_zh-CN.png)
...
|www.aliyun.com|\*.aliyun.com|\*.market.aliyun.com|
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/17005/15350112548324_zh-CN.png)
