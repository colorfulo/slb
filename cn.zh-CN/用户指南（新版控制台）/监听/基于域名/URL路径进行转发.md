...
![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/4135/15372432892798_zh-CN.png)
...
5.  单击目标七层监听的**添加转发策略**选项。
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/15660/15372432897453_zh-CN.png)
...
7.  在添加转发策略页面，根据以下信息配置转发策略：
    ...
    4.  **备注（可选）**：输入描述。
    5.  单击**确定**。
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/15660/15372432907463_zh-CN.png)
...
6.  在**转发策略列表**区域，单击目标转发策略的**编辑**选项。
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/15660/15372432907464_zh-CN.png)
...
可选值2-10，默认为3次。
 ...
 |
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/15660/153724329011504_zh-CN.png)
...
6.  在**转发策略列表**区域，单击目标转发策略的**删除**选项。
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/15660/15372432907465_zh-CN.png)
