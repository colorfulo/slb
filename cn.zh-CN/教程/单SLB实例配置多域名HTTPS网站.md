# 单SLB实例配置多域名HTTPS网站 {#concept_rks_s4t_q2b .concept}
...
-   上传本教程中需要使用的证书，具体操作请参见[上传证书](../cn.zh-CN/用户指南（新版控制台）/证书管理/上传证书.md#)。
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/15661/15380147848320_zh-CN.png)
...
3.  在转发策略页面，配置转发策略，详情请参见[基于域名/URL路径进行转发](../cn.zh-CN/教程/基于域名/URL路径进行转发.md#)。
    ...
    **说明：** 转发规则中设置的域名，必须与证书中和[步骤三 添加扩展域名](../cn.zh-CN/教程/单SLB实例配置多域名HTTPS网站.md#section_bk4_ypt_q2b)中添加的扩展域名保持一致。

    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/17005/15380147848327_zh-CN.png)
...
2.  在监听页签下，找到已创建的HTTPS监听，选择**更多** \> **扩展域名管理**。
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/17020/153801478410044_zh-CN.png)
...
|www.aliyun.com|\*.aliyun.com|\*.market.aliyun.com|
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/17005/15380147848324_zh-CN.png)
